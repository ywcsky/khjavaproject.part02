...
public class MemberView {
    ...
    public String searchInput(String msg) {
        System.out.print(msg + " 입력 : ");
        return sc.next();
    }

    public void showCondition(Member member, String msg2) {
    ...
    public Member updateMember() {
        ...
        System.out.print("취미 : ");
        String hobby = sc.next();
        return new Member(pwd, name, gender, email, phone, address, hobby, age);
    }
}
